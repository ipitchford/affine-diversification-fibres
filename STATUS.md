...
The separate CRABS comparison found endpoint deficits in all 240 returned primary clouds plus 60 structural censors. Exact certification changed 532 of 3,840 clustered statuses, below the prespecified 20% H4 gate. H4 therefore failed, and the package must not be called a must-have or essential CRABS complement.

See `STATUS.json` for the authoritative machine-readable gate list.
